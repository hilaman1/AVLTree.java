...
public class AVLTree {
	...
	private IAVLNode treePosition(IAVLNode nodeX,int k) {
		...
		IAVLNode posNode = EXTERNALNODE; //check
...
//        demote(z)
	...
	private void reSize(IAVLNode parent, int i) {
		//todo-check if a check for sizes validity is needed
		while(parent != null) {
	...
	/**
	 * recalculate Height for parent node
	 * */
...
//        return this.max;
	...
	public int size()
	{
		...
		////  todo- update size field during tree functions
